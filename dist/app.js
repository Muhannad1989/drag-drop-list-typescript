...
class Component {
    ...
    attach(posation) {
        this.hostElement.insertAdjacentElement(posation ? 'afterbegin' : 'beforeend', this.element);
    }
}
...
class ProjectList extends Component {
    ...
    dropHandler(event) {
        ...
        projectState.moveProject(proId, this.type === 'active' ? Status.Active : Status.Finished);
    }
    dragLeaveHandler(_) {
        const listEl = this.element.querySelector('ul');
